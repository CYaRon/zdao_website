...
<html lang="zh">
    <head>
        ...
        <title>文章精选</title>
        <link rel="stylesheet" href="./css/article.css?v=101">
    ...
    <body>
        ...
        <div class="content">
            <div class="subnav">
                <p><a href="./index">首页</a>&nbsp;&gt;&nbsp;<a href="javascript:void(0)">专业文章</a>&nbsp;&gt;&nbsp;文章精选
                        <?php
                            require("connect.php");
                            $pageNo = $_GET["pageNo"];
                            $pageSize = 8;
                            $pageIndex = ($pageNo - 1) * $pageSize;
                            $sql = "SELECT COUNT(id)total FROM article;";
            ...
            <ul class="article">
                <?php
                    $sql = "SELECT id, title, read_num, like_num, href,update_time FROM article ORDER BY id ASC LIMIT {$pageIndex},{$pageSize}";
                    $result = $conn->query($sql);
