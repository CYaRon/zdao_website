...
<html lang="zh">
    ...
    <body>
        ...
        <div class="content">
            <div class="subnav">
                <p><a href="./index">首页</a>&nbsp;&gt;&nbsp;<a href="./article?pageNo=1">专业文章</a>&nbsp;&gt;&nbsp;文章详情</p>
            </div>
            ...
            <div class="article-jump">
                <li id="jump-up">
                    <?php
                        if ($_GET["id"]>1){
                            echo "<a href=\"./articles?id=".($_GET["id"]-1)."\">&lt;上一篇</a> ";
                        }else{
                ...
                <li id="jump-down">
                    <?php
                        ...
                        if ($_GET["id"]<$row["total"]){
                            echo "<a href=\"./articles?id=".($_GET["id"]+1)."\">下一篇&gt;</a> ";
                        }else{
        ...
        <?php
         ...
         ?>
        <script>
            document.querySelector('#article-share').addEventListener('click', function () {
                Mshare.popup({
