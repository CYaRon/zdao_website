...
(function($) {
    ...
    Pager.prototype = {
        ...
        _render: function() {
             ...
             * @return {String}
             */
            function __template(className, data_page, content) {//onclick="showHint()"
                return '<a href=javascript:; class="' + className.join(' ') + '" data-page="' + data_page + '" onclick="showCourseList('+ (data_page+1) +')" >' + (content) + '</a> ';
            }
            //渲染数字按钮
